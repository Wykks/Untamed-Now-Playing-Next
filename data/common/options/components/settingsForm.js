(() => {
            ...
            return h('form', { class: 'options' },
                ...
                h(formOption, { title: t('opt_4'), tooltip: t('opt_tt_4') },
                    ...
                    h('div', { class: 'checkbox' },
                        h('input', {
                            type: 'checkbox',
                            value: this.state.songMaxlenAppend,
                ...
                h('p', { class: 'save' },
                    h('button', { class: 'save-btn', type: 'button', onClick: this.onSubmit }, t('save'))
                )
            );
        }
    }
    ...
    const formOption = ({ title, value, onChange, type, tooltip, children }) => {
        ...
        case 'select':
            ...
            break;
        case 'checkbox':
            content = h('input', { id: title, type: 'checkbox', value, onChange });
            break;
        default:
