var AnimenfoTrackListener = function() { };
...
AnimenfoTrackListener.prototype.scrapPlayData = function() {
	...
	this.trackName  = $.trim(this.selector.contents().filter(function(){ return this.nodeType == Node.TEXT_NODE; })[3].nodeValue);
	if (this.trackName === "") //Sometimes, infos are moved
		this.trackName  = $.trim(this.selector.contents().filter(function(){ return this.nodeType == Node.TEXT_NODE; })[5].nodeValue);
	return true;
}
